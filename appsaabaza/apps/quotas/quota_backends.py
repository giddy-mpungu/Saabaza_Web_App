...
from appsaabaza.apps.documents.events import event_document_create
from appsaabaza.apps.documents.models import Document, DocumentVersion
from appsaabaza.apps.user_management.querysets import get_user_queryset
...
class DocumentCountQuota(
    ...
    sender = Document
    signal = signal_appsaabaza_pre_save
