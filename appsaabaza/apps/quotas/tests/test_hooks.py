...
from appsaabaza.apps.documents.models.document_models import Document
from appsaabaza.apps.documents.permissions import (
    permission_document_create, permission_document_new_version
)
from appsaabaza.apps.documents.tests.base import DocumentTestMixin
from appsaabaza.apps.documents.tests.literals import TEST_SMALL_DOCUMENT_PATH
from appsaabaza.apps.sources.tests.mixins import (
...
class QuotaHooksTestCase(
    ...
    def setUp(self):
        ...
        self._silence_logger(name='appsaabaza.apps.sources.views')
        self._silence_logger(name='appsaabaza.apps.common.middleware.error_logging')
