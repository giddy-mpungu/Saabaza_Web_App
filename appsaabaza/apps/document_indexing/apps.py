...
from appsaabaza.apps.documents.signals import post_document_created, post_initial_document_type
...
class DocumentIndexingApp(AppsaabazaAppConfig):
    app_namespace = 'indexing'
    app_url = 'indexing'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.document_indexing'
