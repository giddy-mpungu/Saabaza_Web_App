from appsaabaza.apps.documents.permissions import permission_document_new_version
from appsaabaza.apps.documents.tests.base import GenericDocumentViewTestCase
from appsaabaza.apps.sources.links import link_document_version_upload
