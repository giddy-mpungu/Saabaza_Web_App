...
class APIGroupListView(generics.ListCreateAPIView):
    ...
    """
    appsaabaza_object_permissions = {'GET': (permission_group_view,)}
    appsaabaza_view_permissions = {'POST': (permission_group_create,)}
...
class APIUserListView(generics.ListCreateAPIView):
    ...
    """
    appsaabaza_object_permissions = {'GET': (permission_user_view,)}
    appsaabaza_view_permissions = {'POST': (permission_user_create,)}
