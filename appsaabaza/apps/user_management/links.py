...
from appsaabaza.apps.navigation.classes import Link, Separator, Text
...
link_user_set_options = Link(
    args='object.id',
    icon_class_path='appsaabaza.apps.user_management.icons.icon_user_set_options',
    permissions=(permission_user_edit,),
    text=_('User options'), view='user_management:user_options',
)
link_user_setup = Link(
    icon_class_path='appsaabaza.apps.user_management.icons.icon_user_setup',
    permissions=(permission_user_view,), text=_('Users'),
    view='user_management:user_list'
)
