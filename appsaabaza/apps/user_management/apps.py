...
from appsaabaza.apps.metadata.classes import MetadataLookup
...
class UserManagementApp(AppsaabazaAppConfig):
    app_namespace = 'user_management'
    app_url = 'accounts'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.user_management'
    ...
    def ready(self):
        ...
        DynamicSerializerField.add_serializer(
            ...
            serializer_class='appsaabaza.apps.user_management.serializers.UserSerializer'
        )
