...
from appsaabaza.apps.documents.permissions import (
...
link_document_type_smart_links = Link(
    ...
    icon_class_path='appsaabaza.apps.linking.icons.icon_document_type_smart_links',
...
link_smart_link_condition_create = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_condition_create',
...
link_smart_link_condition_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_condition_delete',
...
link_smart_link_condition_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_condition_edit',
    permissions=(permission_smart_link_edit,),
    text=_('Edit'), view='linking:smart_link_condition_edit',
)
link_smart_link_condition_list = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_condition_list',
    permissions=(permission_smart_link_edit,),
    text=_('Conditions'), view='linking:smart_link_condition_list',
)
link_smart_link_create = Link(
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_create',
...
link_smart_link_delete = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_delete',
...
link_smart_link_document_types = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_document_types',
    permissions=(permission_smart_link_edit,),
    text=_('Document types'), view='linking:smart_link_document_types',
)
link_smart_link_edit = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_edit',
    permissions=(permission_smart_link_edit,),
...
link_smart_link_instances_for_document = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_instances_for_document',
...
link_smart_link_list = Link(
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_list',
    permissions=(permission_smart_link_create,), text=_('Smart links'),
    view='linking:smart_link_list'
)
link_smart_link_setup = Link(
    icon_class_path='appsaabaza.apps.linking.icons.icon_smart_link_setup',
    permissions=(permission_smart_link_create,), text=_('Smart links'),
    view='linking:smart_link_list'
)
