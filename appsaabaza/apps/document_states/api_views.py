...
from appsaabaza.apps.documents.permissions import permission_document_type_view
...
class APIWorkflowRuntimeProxyListView(generics.ListCreateAPIView):
    ...
    """
    appsaabaza_object_permissions = {'GET': (permission_workflow_view,)}
    appsaabaza_view_permissions = {'POST': (permission_workflow_create,)}
    queryset = Workflow.objects.all()
