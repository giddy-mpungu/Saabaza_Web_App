...
from appsaabaza.apps.common.links import link_object_error_list
...
from appsaabaza.apps.common.permissions_runtime import permission_error_log_view
...
class DocumentStatesApp(AppsaabazaAppConfig):
    app_namespace = 'document_states'
    app_url = 'workflows'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.document_states'
