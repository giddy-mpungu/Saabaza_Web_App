...
from appsaabaza.apps.documents.permissions import permission_document_type_edit
from appsaabaza.apps.navigation.classes import Link
from appsaabaza.apps.navigation.utils import get_cascade_condition
...
link_document_type_workflow_templates = Link(
    ...
    icon_class_path='appsaabaza.apps.document_states.icons.icon_document_type_workflow_list',
...
link_workflow_template_create = Link(
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_create',
...
link_workflow_template_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_delete',
...
link_workflow_template_document_types = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_document_type_list',
...
link_workflow_template_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_edit',
...
link_workflow_template_launch = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_launch',
...
link_workflow_template_list = Link(
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_list',
...
link_workflow_template_preview = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_template_preview',
...
link_workflow_template_state_action_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_action_delete',
    permissions=(permission_workflow_edit,),
    tags='dangerous', text=_('Delete'),
...
link_workflow_template_state_action_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_action_edit',
    permissions=(permission_workflow_edit,),
    text=_('Edit'), view='document_states:workflow_template_state_action_edit',
)
link_workflow_template_state_action_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_action_list',
    permissions=(permission_workflow_edit,),
    text=_('Actions'),
...
link_workflow_template_state_action_selection = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_action',
...
link_workflow_template_state_create = Link(
    args='workflow.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_create',
...
link_workflow_template_state_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_delete',
    permissions=(permission_workflow_edit,),
    tags='dangerous', text=_('Delete'),
...
link_workflow_template_state_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state_edit',
    permissions=(permission_workflow_edit,),
    text=_('Edit'), view='document_states:workflow_template_state_edit',
)
link_workflow_template_state_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_state',
...
link_workflow_template_transition_create = Link(
    args='workflow.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_create',
...
link_workflow_template_transition_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_delete',
    permissions=(permission_workflow_edit,),
    tags='dangerous', text=_('Delete'),
...
link_workflow_template_transition_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_edit',
    permissions=(permission_workflow_edit,),
    text=_('Edit'), view='document_states:workflow_template_transition_edit',
)
link_workflow_template_transition_events = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_triggers',
    permissions=(permission_workflow_edit,),
...
link_workflow_template_transition_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition',
...
link_workflow_template_transition_field_create = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_field',
...
link_workflow_template_transition_field_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_field_delete',
    permissions=(permission_workflow_edit,),
    tags='dangerous', text=_('Delete'),
...
link_workflow_template_transition_field_edit = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_field_edit',
    permissions=(permission_workflow_edit,),
...
link_workflow_template_transition_field_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_transition_field_list',
    permissions=(permission_workflow_edit,),
    text=_('Fields'),
...
link_workflow_instance_detail = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_instance_detail',
    permissions=(permission_workflow_view,),
    text=_('Detail'), view='document_states:workflow_instance_detail',
)
link_workflow_instance_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_instance_list',
    permissions=(permission_workflow_view,), text=_('Workflows'),
    view='document_states:workflow_instance_list',
)
link_workflow_instance_transition = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_instance_transition',
    text=_('Transition'),
...
link_workflow_runtime_proxy_document_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_runtime_proxy_document_list',
    permissions=(permission_workflow_view,),
...
link_workflow_runtime_proxy_list = Link(
    ...
    ), icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_runtime_proxy_list',
    text=_('Workflows'), view='document_states:workflow_runtime_proxy_list'
)
link_workflow_runtime_proxy_state_document_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_runtime_proxy_state_document_list',
    permissions=(permission_workflow_view,),
...
link_workflow_runtime_proxy_state_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.document_states.icons.icon_workflow_runtime_proxy_state_list',
    permissions=(permission_workflow_view,),
...
link_tool_launch_workflows = Link(
    icon_class_path='appsaabaza.apps.document_states.icons.icon_tool_launch_workflows',
    permissions=(permission_workflow_tools,),
