...
from appsaabaza.apps.common.tests.mixins import TestServerTestCaseMixin
from appsaabaza.apps.common.tests.mocks import request_method_factory
...
class HTTPWorkflowActionViewTestCase(
    ...
    def test_http_workflow_state_action_create_post_view_no_permission(self):
        ...
        response = self._request_test_workflow_template_state_action_create_post_view(
            class_path='appsaabaza.apps.document_states.workflow_actions.HTTPAction',
            extra_data={
