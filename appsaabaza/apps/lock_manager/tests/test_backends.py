...
class FileLockTestCase(BaseTestCase):
    backend_string = 'appsaabaza.apps.lock_manager.backends.file_lock.FileLock'
...
class ModelLockTestCase(FileLockTestCase):
    backend_string = 'appsaabaza.apps.lock_manager.backends.model_lock.ModelLock'
...
class RedisLockTestCase(FileLockTestCase):
    backend_string = 'appsaabaza.apps.lock_manager.backends.redis_lock.RedisLock'
