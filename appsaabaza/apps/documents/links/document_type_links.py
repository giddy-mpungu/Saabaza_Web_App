...
link_document_type_policies = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_policies',
...
link_document_type_filename_create = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_filename_create',
    permissions=(permission_document_type_edit,),
...
link_document_type_filename_delete = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_filename_delete',
    permissions=(permission_document_type_edit,),
...
link_document_type_filename_edit = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_filename_edit',
    permissions=(permission_document_type_edit,),
    text=_('Edit'), view='documents:document_type_filename_edit',
)
link_document_type_filename_list = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_filename_list',
...
link_document_type_list = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_list',
