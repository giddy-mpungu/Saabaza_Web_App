...
link_document_version_list = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_list',
...
link_document_version_download = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_download',
...
link_document_version_return_document = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_return_document',
...
link_document_version_return_list = Link(
    args='resolved_object.document.pk',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_return_list',
...
link_document_version_view = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_view',
    permissions=(permission_document_version_view,),
...
link_document_version_revert = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_version_revert',
