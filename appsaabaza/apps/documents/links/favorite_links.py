...
link_document_list_favorites = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_favorite_document_list',
    text=_('Favorites'),
    view='documents:document_list_favorites'
)
link_document_favorites_add = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_favorite_document_add',
...
link_document_favorites_remove = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_favorite_document_remove',
