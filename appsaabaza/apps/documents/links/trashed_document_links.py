...
link_document_delete = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_trashed_document_delete',
...
link_document_trash = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_trash_send',
    tags='dangerous', text=_('Move to trash'),
    view='documents:document_trash',
)
link_document_list_deleted = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_trashed_document_list',
    text=_('Trash can'), view='documents:document_list_deleted'
)
link_document_restore = Link(
    permissions=(permission_document_restore,),
    icon_class_path='appsaabaza.apps.documents.icons.icon_trashed_document_restore',
    text=_('Restore'),
