...
link_document_page_disable = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_page_disable',
...
link_document_page_enable = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_page_enable',
    kwargs={'document_page_id': 'resolved_object.id'},
...
link_document_page_view = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_page_view',
...
link_document_page_view_reset = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_page_view_reset',
...
link_document_pages = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_pages',
...
link_document_multiple_update_page_count = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_page_count_update',
