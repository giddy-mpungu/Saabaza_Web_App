...
from appsaabaza.apps.converter.permissions import (
...
link_document_clear_transformations = Link(
    ...
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_transformations_clear',
...
link_document_clone_transformations = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_transformations_clone',
...
link_document_document_type_edit = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_type_change',
...
link_document_download = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_download',
...
link_document_edit = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_edit',
...
link_document_list = Link(
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_list',
...
link_document_preview = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_preview',
    permissions=(permission_document_view,),
    text=_('Preview'), view='documents:document_preview',
)
link_document_properties = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_properties',
    permissions=(permission_document_view,),
    text=_('Properties'), view='documents:document_properties',
)
link_document_print = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_print',
    permissions=(permission_document_print,),
    text=_('Print'), view='documents:document_print',
)
link_document_quick_download = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.documents.icons.icon_document_quick_download',
