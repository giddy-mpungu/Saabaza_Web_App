...
from appsaabaza.apps.task_manager.workers import worker_fast, worker_medium
...
queue_converter.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_generate_document_page_image',
    label=_('Generate document page image')
)

queue_documents.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_delete_document',
    label=_('Delete a document')
)
queue_documents.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_clean_empty_duplicate_lists',
    label=_('Clean empty duplicate lists')
)

queue_documents_periodic.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_check_delete_periods',
...
queue_documents_periodic.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_check_trash_periods',
...
queue_documents_periodic.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_delete_stubs',
...
queue_tools.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_scan_duplicates_all',
    label=_('Duplicated document scan')
)

queue_uploads.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_update_page_count',
    label=_('Update document page count')
)
queue_uploads.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_upload_new_version',
    label=_('Upload new document version')
)
queue_uploads.add_task_type(
    dotted_path='appsaabaza.apps.documents.tasks.task_scan_duplicates_for',
