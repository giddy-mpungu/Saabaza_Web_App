...
from appsaabaza.apps.common.literals import TIME_DELTA_UNIT_DAYS
...
TEST_PDF_DOCUMENT_FILENAME = 'appsaabaza_11_1.pdf'
...
TEST_TRASH_DOCUMENT_WORKFLOW_ACTION_DOTTED_PATH = 'appsaabaza.apps.documents.workflow_actions.TrashDocumentAction'
