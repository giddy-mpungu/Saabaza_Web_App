...
class Migration(migrations.Migration):
    dependencies = [
        ('documents', '0025_auto_20150718_0742'),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                blank=True, choices=[
                    ...
                    ['afa', 'Afro-Asiatic languages'], ['afh', 'Afrihili'],
                    ['afr', 'Afrikaans'], ['ain', 'Ainu'],
                    ...
                    ['bul', 'Bulgarian'], ['mya', 'Burmese'],
                    ['byn', 'Blin; Bilin'], ['cad', 'Caddo'],
                    ['cai', 'Central American Indian languages'],
                    ['car', 'Galibi Carib'], ['cat', 'Catalan; Valencian'],
                    ['cau', 'Caucasian languages'], ['ceb', 'Cebuano'],
                    ['cel', 'Celtic languages'], ['cha', 'Chamorro'],
                    ['chb', 'Chibcha'], ['che', 'Chechen'],
                    ['chg', 'Chagatai'], ['zho', 'Chinese'],
                    ['chk', 'Chuukese'], ['chm', 'Mari'],
                    ['chn', 'Chinook jargon'], ['cho', 'Choctaw'],
                    ['chp', 'Chipewyan; Dene Suline'], ['chr', 'Cherokee'],
                    [
                    ...
                    ['crp', 'Creoles and pidgins'], ['csb', 'Kashubian'],
                    ['cus', 'Cushitic languages'], ['ces', 'Czech'],
                    ['dak', 'Dakota'], ['dan', 'Danish'],
                    ['dar', 'Dargwa'], ['day', 'Land Dayak languages'],
                    ['del', 'Delaware'], ['den', 'Slave (Athapascan)'],
                    ['dgr', 'Dogrib'], ['din', 'Dinka'],
                    ['div', 'Divehi; Dhivehi; Maldivian'],
                    ['doi', 'Dogri'], ['dra', 'Dravidian languages'],
                    ['dsb', 'Lower Sorbian'], ['dua', 'Duala'],
                    ['dum', 'Dutch, Middle (ca. 1050-1350)'],
                    ['nld', 'Dutch; Flemish'], ['dyu', 'Dyula'],
                    ['dzo', 'Dzongkha'], ['efi', 'Efik'],
                    ['egy', 'Egyptian (Ancient)'], ['eka', 'Ekajuk'],
                    ['elx', 'Elamite'], ['eng', 'English'],
                    ['enm', 'English, Middle (1100-1500)'],
                    ['epo', 'Esperanto'], ['est', 'Estonian'],
                    ['ewe', 'Ewe'], ['ewo', 'Ewondo'], ['fan', 'Fang'],
                    ['fao', 'Faroese'], ['fat', 'Fanti'],
                    ['fij', 'Fijian'], ['fil', 'Filipino; Pilipino'],
                    ['fin', 'Finnish'], ['fiu', 'Finno-Ugrian languages'],
                    ['fon', 'Fon'], ['fra', 'French'],
                    ...
                    ['frs', 'Eastern Frisian'],
                    ['fry', 'Western Frisian'],
                    ['ful', 'Fulah'], ['fur', 'Friulian'], ['gaa', 'Ga'],
                    ['gay', 'Gayo'], ['gba', 'Gbaya'],
                    ['gem', 'Germanic languages'], ['kat', 'Georgian'],
                    ['deu', 'German'], ['gez', 'Geez'],
                    ['gil', 'Gilbertese'],
                    ['gla', 'Gaelic; Scottish Gaelic'], ['gle', 'Irish'],
                    ['glg', 'Galician'], ['glv', 'Manx'],
                    ...
                    ['guj', 'Gujarati'], ['gwi', b"Gwich'in"],
                    ['hai', 'Haida'], ['hat', 'Haitian; Haitian Creole'],
                    ...
                    ['ile', 'Interlingue; Occidental'], ['ilo', 'Iloko'],
                    [
                        b'ina', 'Interlingua (International Auxiliary '
                        'Language Association)'
                    ],
                    ['inc', 'Indic languages'], ['ind', 'Indonesian'],
                    ['ine', 'Indo-European languages'],
                    ['inh', 'Ingush'], ['ipk', 'Inupiaq'],
                    ['ira', 'Iranian languages'],
                    ['iro', 'Iroquoian languages'], ['ita', 'Italian'],
                    ['jav', 'Javanese'], ['jbo', 'Lojban'],
                    ['jpn', 'Japanese'], ['jpr', 'Judeo-Persian'],
                    ['jrb', 'Judeo-Arabic'], ['kaa', 'Kara-Kalpak'],
                    ['kab', 'Kabyle'], ['kac', 'Kachin; Jingpho'],
                    ...
                    ['khm', 'Central Khmer'], ['kho', 'Khotanese;Sakan'],
                    ...
                    ['kum', 'Kumyk'], ['kur', 'Kurdish'],
                    ['kut', 'Kutenai'], ['lad', 'Ladino'],
                    ['lah', 'Lahnda'], ['lam', 'Lamba'],
                    ['lao', 'Lao'], ['lat', 'Latin'],
                    ['lav', 'Latvian'], ['lez', 'Lezghian'],
                    ...
                    ['ndo', 'Ndonga'],
                    [
                        b'nds', 'Low German; Low Saxon; German, Low; '
                        'Saxon, Low'
                    ],
                    ...
                    ['fas', 'Persian'], ['phi', 'Philippine languages'],
                    ['phn', 'Phoenician'], ['pli', 'Pali'],
                    ['pol', 'Polish'], ['pon', 'Pohnpeian'],
                    ['por', 'Portuguese'], ['pra', 'Prakrit languages'],
                    [
                        b'pro', 'Proven\xe7al, Old (to 1500); Occitan, Old '
                        '(to 1500)'
                    ],
                    ['pus', 'Pushto; Pashto'],
                    ...
                    ['smi', 'Sami languages'], ['smj', 'Lule Sami'],
                    ['smn', 'Inari Sami'], ['smo', 'Samoan'],
                    ['sms', 'Skolt Sami'], ['sna', 'Shona'],
                    ['snd', 'Sindhi'], ['snk', 'Soninke'],
                    ['sog', 'Sogdian'], ['som', 'Somali'],
                    ['son', 'Songhai languages'],
                    ['sot', 'Sotho, Southern'],
                    ['spa', 'Spanish; Castilian'], ['srd', 'Sardinian'],
                    ['srn', 'Sranan Tongo'], ['srp', 'Serbian'],
                    ['srr', 'Serer'], ['ssa', 'Nilo-Saharan languages'],
                    ['ssw', 'Swati'], ['suk', 'Sukuma'],
                    ['sun', 'Sundanese'], ['sus', 'Susu'],
                    ['sux', 'Sumerian'], ['swa', 'Swahili'],
                    ['swe', 'Swedish'], ['syc', 'Classical Syriac'],
                    ['syr', 'Syriac'], ['tah', 'Tahitian'],
                    ['tai', 'Tai languages'], ['tam', 'Tamil'],
                    ['tat', 'Tatar'], ['tel', 'Telugu'],
                    ['tem', 'Timne'], ['ter', 'Tereno'],
                    ['tet', 'Tetum'], ['tgk', 'Tajik'],
                    ['tgl', 'Tagalog'], ['tha', 'Thai'],
                    ['bod', 'Tibetan'], ['tig', 'Tigre'],
                    ['tir', 'Tigrinya'], ['tiv', 'Tiv'],
                    ['tkl', 'Tokelau'], ['tlh', 'Klingon; tlhIngan-Hol'],
                    ['tli', 'Tlingit'], ['tmh', 'Tamashek'],
                    ['tog', 'Tonga (Nyasa)'],
                    ['ton', 'Tonga (Tonga Islands)'], ['tpi', 'Tok Pisin'],
                    ['tsi', 'Tsimshian'], ['tsn', 'Tswana'],
                    ['tso', 'Tsonga'], ['tuk', 'Turkmen'],
                    ['tum', 'Tumbuka'], ['tup', 'Tupi languages'],
                    ['tur', 'Turkish'], ['tut', 'Altaic languages'],
                    ['tvl', 'Tuvalu'], ['twi', 'Twi'],
                    ['tyv', 'Tuvinian'], ['udm', 'Udmurt'],
                    ['uga', 'Ugaritic'], ['uig', 'Uighur; Uyghur'],
                    ['ukr', 'Ukrainian'], ['umb', 'Umbundu'],
                    ['und', 'Undetermined'], ['urd', 'Urdu'],
                    ['uzb', 'Uzbek'], ['vai', 'Vai'],
                    ['ven', 'Venda'], ['vie', 'Vietnamese'],
                    ['vol', 'Volap\xfck'], ['vot', 'Votic'],
                    ...
                    ['zha', 'Zhuang; Chuang'], ['znd', 'Zande languages'],
                    ['zul', 'Zulu'], ['zun', 'Zuni'],
