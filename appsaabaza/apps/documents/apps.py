...
from appsaabaza.apps.common.classes import (
...
from appsaabaza.apps.common.signals import post_initial_setup
from appsaabaza.apps.dashboards.dashboards import dashboard_main
...
from appsaabaza.apps.rest_api.fields import DynamicSerializerField
...
class DocumentsApp(AppsaabazaAppConfig):
    app_namespace = 'documents'
    app_url = 'documents'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.documents'
    ...
    def ready(self):
        ...
        DynamicSerializerField.add_serializer(
            klass=Document,
            serializer_class='appsaabaza.apps.documents.serializers.DocumentSerializer'
        )
        ...
        MissingItem(
            ...
            description=_(
                ...
                'it is the basic way Appsaabaza EDMS categorizes documents.'
