...
from appsaabaza.apps.common.literals import LIST_MODE_CHOICE_ITEM
from appsaabaza.apps.dynamic_search.classes import SearchModel
...
document_search = SearchModel(
    ...
    serializer_path='appsaabaza.apps.documents.serializers.DocumentSerializer'
)
...
document_page_search = SearchModel(
    ...
    serializer_path='appsaabaza.apps.documents.serializers.DocumentPageSerializer'
)
