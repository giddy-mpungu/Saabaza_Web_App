...
from appsaabaza.apps.common.generics import DownloadMixin
...
class APITrashedDocumentListView(generics.ListAPIView):
    ...
    """
    appsaabaza_object_permissions = {'GET': (permission_document_view,)}
...
class APIDocumentTypeListView(generics.ListCreateAPIView):
    ...
    """
    appsaabaza_object_permissions = {'GET': (permission_document_type_view,)}
    appsaabaza_view_permissions = {'POST': (permission_document_type_create,)}
