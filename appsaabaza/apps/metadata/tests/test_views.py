...
from appsaabaza.apps.common.settings import setting_home_view
from appsaabaza.apps.common.tests.base import GenericViewTestCase
from appsaabaza.apps.documents.models import DocumentType
...
from appsaabaza.apps.documents.tests.literals import TEST_DOCUMENT_TYPE_2_LABEL
...
class DocumentMetadataViewTestCase(
    ...
    def test_document_metadata_remove_get_view_with_full_access(self):
        ...
        self._silence_logger(name='appsaabaza.apps.navigation.classes')
