...
link_metadata_add = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_document_metadata_add',
    permissions=(permission_document_metadata_add,), text=_('Add metadata'),
    view='metadata:metadata_add',
)
link_metadata_edit = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_document_metadata_edit',
...
link_metadata_multiple_remove = Link(
    icon_class_path='appsaabaza.apps.metadata.icons.icon_document_metadata_remove',
...
link_metadata_view = Link(
    ...
    icon_class_path='appsaabaza.apps.metadata.icons.icon_document_metadata_view',
...
link_setup_document_type_metadata_types = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_document_type_metadata_type_list',
...
link_setup_metadata_type_document_types = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_metadata_type_document_type_list',
    permissions=(permission_document_type_edit,),
    text=_('Document types'), view='metadata:setup_metadata_type_document_types',
)
link_setup_metadata_type_create = Link(
    icon_class_path='appsaabaza.apps.metadata.icons.icon_metadata_type_create',
...
link_setup_metadata_type_delete = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_metadata_type_delete',
...
link_setup_metadata_type_edit = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.metadata.icons.icon_metadata_type_edit',
...
link_setup_metadata_type_list = Link(
    icon_class_path='appsaabaza.apps.metadata.icons.icon_metadata_type_list',
