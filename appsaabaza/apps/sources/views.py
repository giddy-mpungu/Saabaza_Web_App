...
from appsaabaza.apps.documents.models import (
    DocumentType, Document, DocumentVersion
)
from appsaabaza.apps.documents.permissions import (
    permission_document_create, permission_document_new_version
)
from appsaabaza.apps.documents.tasks import task_upload_new_version
                    ...
                    },
                    {
                        ...
                        'context': {
                            ...
                            'no_results_text': _(
                                ...
                                'for Appsaabaza EDMS doesn\'t have the necessary '
