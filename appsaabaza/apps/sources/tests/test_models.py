...
from appsaabaza.apps.common.serialization import yaml_dump
from appsaabaza.apps.documents.models import Document
from appsaabaza.apps.documents.tests.base import GenericDocumentTestCase
...
from appsaabaza.apps.metadata.models import MetadataType
...
class WatchFolderTestCase(WatchFolderTestMixin, GenericDocumentTestCase):
    ...
    def test_issue_gh_163(self):
        ...
        gh-issue #163 https://github.com/Saabaza_Web_App/Saabaza_Web_App/issues/163
        """
        self._create_test_watchfolder()
