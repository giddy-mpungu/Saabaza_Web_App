...
from appsaabaza.apps.common.classes import MissingItem
...
from appsaabaza.apps.common.signals import post_initial_setup, post_upgrade
from appsaabaza.apps.converter.links import link_transformation_list
from appsaabaza.apps.documents.menus import menu_documents
from appsaabaza.apps.documents.signals import post_version_upload
...
class SourcesApp(AppsaabazaAppConfig):
    app_namespace = 'sources'
    app_url = 'sources'
    has_rest_api = True
    has_static_media = True
    has_tests = True
    name = 'appsaabaza.apps.sources'
    ...
    def ready(self):
        ...
        MissingItem(
            ...
            description=_(
                ...
                'feed to Appsaabaza EDMS, create at least a web form source to '
