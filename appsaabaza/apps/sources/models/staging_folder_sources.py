...
class StagingFolderSource(InteractiveSource):
    ...
    machine where Appsaabaza is installed. This folder is then used as the
    ...
    computer, open Appsaabaza, select to upload a new document but choose the
    ...
    convert the scanned files into Appsaabaza EDMS documents. Staging folders are
