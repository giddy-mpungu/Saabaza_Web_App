...
from appsaabaza.apps.common.serialization import yaml_load
from appsaabaza.apps.documents.models import Document
from appsaabaza.apps.metadata.api import set_bulk_metadata
...
class EmailBaseModel(IntervalBaseModel):
    ...
    Appsaabaza POP3 or IMAP source. Appsaabaza will periodically download the emails
    and process them as Appsaabaza documents.
    """
