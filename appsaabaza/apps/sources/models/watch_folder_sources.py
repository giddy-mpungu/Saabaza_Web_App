...
class WatchFolderSource(IntervalBaseModel):
    ...
    Administrators can define watch folders, examples /home/appsaabaza/watch_bills
    or /home/appsaabaza/watch_invoices and users just need to copy the documents
    they want to upload as a bill or invoice to the respective filesystem
    folder. Appsaabaza will periodically scan these filesystem locations and
