...
from appsaabaza.apps.common.compressed_files import Archive
from appsaabaza.apps.common.exceptions import NoMIMETypeMatch
...
from appsaabaza.apps.documents.settings import setting_language
    ...
    def save(self, *args, **kwargs):
        ...
        with transaction.atomic():
            ...
            PeriodicTask.objects.create(
                ...
                task='appsaabaza.apps.sources.tasks.task_check_interval_source',
