...
link_document_create_multiple = Link(
    ...
    icon_class_path='appsaabaza.apps.sources.icons.icon_document_create_multiple',
    text=_('New document'),
    view='sources:document_create_multiple'
)
link_setup_sources = Link(
    icon_class_path='appsaabaza.apps.sources.icons.icon_setup_sources',
...
link_setup_source_create_imap_email = Link(
    ...
    icon_class_path='appsaabaza.apps.sources.icons.icon_source_create',
...
link_setup_source_delete = Link(
    ...
    icon_class_path='appsaabaza.apps.sources.icons.icon_setup_source_delete',
...
link_setup_source_edit = Link(
    args=('resolved_object.pk',),
    icon_class_path='appsaabaza.apps.sources.icons.icon_setup_source_edit',
    permissions=(permission_sources_setup_edit,), text=_('Edit'),
    view='sources:setup_source_edit',
)
link_source_list = Link(
    icon_class_path='appsaabaza.apps.sources.icons.icon_source_list',
...
link_staging_file_delete = Link(
    ...
    icon_class_path='appsaabaza.apps.sources.icons.icon_staging_file_delete',
...
link_document_version_upload = Link(
    ...
    icon_class_path='appsaabaza.apps.sources.icons.icon_document_version_upload',
...
link_setup_source_check_now = Link(
    args=('resolved_object.pk',),
    icon_class_path='appsaabaza.apps.sources.icons.icon_setup_source_check_now',
