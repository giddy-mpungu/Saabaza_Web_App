...
queue_sources_fast.add_task_type(
    ...
    dotted_path='appsaabaza.apps.sources.tasks.task_generate_staging_file_image'
)
queue_sources_periodic.add_task_type(
    label=_('Check interval source'),
    dotted_path='appsaabaza.apps.sources.tasks.task_check_interval_source'
)
queue_sources.add_task_type(
    label=_('Handle upload'),
    dotted_path='appsaabaza.apps.sources.tasks.task_source_handle_upload'
)
queue_sources.add_task_type(
    label=_('Upload document'),
    dotted_path='appsaabaza.apps.sources.tasks.task_upload_document'
)
