...
link_book = Link(
    ...
    url='https://Saabaza_Web_App.com/book/'
)
...
link_documentation = Link(
    ...
    text=_('Documentation'), url='https://docs.Saabaza_Web_App.com'
)
link_object_error_list = Link(
    icon_class_path='appsaabaza.apps.common.icons.icon_object_error_list',
...
link_object_error_list_clear = Link(
    icon_class_path='appsaabaza.apps.common.icons.icon_object_error_list_clear',
    kwargs=get_kwargs_factory('resolved_object'),
...
link_forum = Link(
    ...
    url='https://forum.Saabaza_Web_App.com'
)
link_license = Link(
...
link_source_code = Link(
    ...
    url='https://gitlab.com/Saabaza_Web_App/Saabaza_Web_App'
)
link_store = Link(
    icon_class=icon_store, tags='new_window', text=_('Online store'),
    url='https://teespring.com/stores/Saabaza_Web_App'
)
link_support = Link(
    icon_class=icon_support, tags='new_window', text=_('Get support'),
    url='http://www.Saabaza_Web_App.com/providers/'
)
link_tools = Link(
