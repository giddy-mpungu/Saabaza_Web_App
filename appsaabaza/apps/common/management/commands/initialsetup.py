...
import appsaabaza
from appsaabaza.settings.literals import SECRET_KEY_FILENAME, SYSTEM_DIR
...
class Command(management.BaseCommand):
    ...
    def initialize_system(self, force=False):
        ...
        settings_path = os.path.join(settings.MEDIA_ROOT, 'appsaabaza_settings')
        ...
        if not os.path.exists(settings.MEDIA_ROOT) or force:
            ...
            with open(version_file_path, 'w') as file_object:
                file_object.write(appsaabaza.__version__)
