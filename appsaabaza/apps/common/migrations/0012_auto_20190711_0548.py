...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='file',
            field=models.FileField(storage=appsaabaza.apps.storage.classes.FakeStorageSubclass(), upload_to=appsaabaza.apps.common.models.upload_to, verbose_name='File'),
        ),
        migrations.AlterField(
