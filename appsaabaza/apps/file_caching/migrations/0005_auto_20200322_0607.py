...
STORAGE_PATH_UPDATE_MAP = {
    'appsaabaza.apps.document_states.storages.storage_workflowimagecache': 'appsaabaza.apps.document_states.storages.storage_workflow_image',
    'appsaabaza.apps.documents.storages.storage_documentimagecache': 'appsaabaza.apps.documents.storages.storage_document_image_cache'
}
