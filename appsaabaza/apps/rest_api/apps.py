...
from appsaabaza.apps.common.menus import menu_tools
from appsaabaza.apps.common.settings import setting_url_base_path
...
class RESTAPIApp(AppsaabazaAppConfig):
    app_url = 'api'
    app_namespace = 'rest_api'
    has_tests = True
    name = 'appsaabaza.apps.rest_api'
