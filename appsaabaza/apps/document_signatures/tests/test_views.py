...
from appsaabaza.apps.django_gpg.permissions import permission_key_sign
from appsaabaza.apps.django_gpg.tests.mixins import KeyTestMixin
from appsaabaza.apps.documents.models import DocumentVersion
from appsaabaza.apps.documents.tests.base import GenericDocumentViewTestCase
from appsaabaza.apps.documents.tests.literals import (
...
class SignaturesViewTestCase(
    ...
    def test_missing_signature_verify_view_no_permission(self):
        ...
        self._silence_logger(name='appsaabaza.apps.converter.backends')
