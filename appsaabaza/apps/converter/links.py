...
link_transformation_delete = LayerLink(
    ...
    icon_class_path='appsaabaza.apps.converter.icons.icon_transformation_delete',
...
link_transformation_edit = LayerLink(
    action='edit', kwargs={
        'layer_name': 'layer_name', 'transformation_id': 'resolved_object.pk'
    }, icon_class_path='appsaabaza.apps.converter.icons.icon_transformation_edit',
    layer=layer_saved_transformations,
...
link_transformation_select = LayerLink(
    action='select',
    icon_class_path='appsaabaza.apps.converter.icons.icon_transformation_select',
