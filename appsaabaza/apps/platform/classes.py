...
from appsaabaza.apps.task_manager.classes import Worker
from appsaabaza.apps.task_manager.settings import (
...
class PlatformTemplateSupervisord(PlatformTemplate):
    ...
    variables = (
        Variable(
            ...
            environment_name='APPSAABAZA_GUNICORN_WORKERS'
        ),
        Variable(
            name='GUNICORN_TIMEOUT', default=120,
            environment_name='APPSAABAZA_GUNICORN_TIMEOUT'
        ),
        Variable(
            name='INSTALLATION_PATH', default='/opt/Saabaza_Web_App',
            environment_name='APPSAABAZA_INSTALLATION_PATH'
        ),
        YAMLVariable(
            name='ALLOWED_HOSTS',
            default=['*'],
            environment_name='APPSAABAZA_ALLOWED_HOSTS'
        ),
        YAMLVariable(
            name='CELERY_BROKER_URL',
            default='redis://:appsaabazaredispassword@127.0.0.1:6379/0',
            environment_name='APPSAABAZA_CELERY_BROKER_URL'
        ),
        YAMLVariable(
            name='CELERY_RESULT_BACKEND',
            default='redis://:appsaabazaredispassword@127.0.0.1:6379/1',
            environment_name='APPSAABAZA_CELERY_RESULT_BACKEND'
        ),
        YAMLVariable(
            name='DATABASES',
            default={
                'default': {
                    ...
                    'NAME': 'appsaabaza', 'PASSWORD': 'appsaabazauserpass',
                    'USER': 'appsaabaza', 'HOST': '127.0.0.1'
                }
            },
            environment_name='APPSAABAZA_DATABASES'
        ),
        YAMLVariable
        (
            name='MEDIA_ROOT', default='/opt/Saabaza_Web_App/media',
            environment_name='APPSAABAZA_MEDIA_ROOT'
        ),
    )
...
class PlatformTemplateWorkerQueues(PlatformTemplate):
    ...
    variables = (
        Variable(
            ...
            environment_name='APPSAABAZA_WORKER_NAME'
        ),
    )
