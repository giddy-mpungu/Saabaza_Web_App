...
from appsaabaza.apps.acls.permissions import (
...
from appsaabaza.apps.common.signals import perform_upgrade
...
class PermissionsApp(AppsaabazaAppConfig):
    app_namespace = 'permissions'
    app_url = 'permissions'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.permissions'
