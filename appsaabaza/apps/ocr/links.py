...
link_document_page_ocr_content = Link(
    ...
    icon_class_path='appsaabaza.apps.ocr.icons.icon_document_page_ocr_content',
    permissions=(permission_ocr_content_view,), text=_('OCR'),
    view='ocr:document_page_ocr_content',
)
link_document_ocr_content = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.ocr.icons.icon_document_ocr_content',
    permissions=(permission_ocr_content_view,), text=_('OCR'),
    view='ocr:document_ocr_content',
)
link_document_ocr_content_delete = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.ocr.icons.icon_document_ocr_content_delete',
...
link_document_submit = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.ocr.icons.icon_document_submit',
...
link_document_type_ocr_settings = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.ocr.icons.icon_document_type_ocr_settings',
