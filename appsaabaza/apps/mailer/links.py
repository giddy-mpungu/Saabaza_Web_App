...
link_send_document = Link(
    ...
    icon_class_path='appsaabaza.apps.mailer.icons.icon_document_send',
    permissions=(permission_mailing_send_document,),
    text=_('Email document'), view='mailer:send_document'
)
link_send_document_link = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.mailer.icons.icon_document_send_link',
...
link_system_mailer_error_log = Link(
    icon_class_path='appsaabaza.apps.mailer.icons.icon_system_mailer_error_log',
...
link_user_mailer_create = Link(
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_create',
...
link_user_mailer_delete = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_delete',
...
link_user_mailer_edit = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_edit',
...
link_user_mailer_list = Link(
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_list',
...
link_user_mailer_setup = Link(
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_setup',
    permissions=(permission_user_mailer_view,),
    text=_('Mailing profiles'), view='mailer:user_mailer_list',
)
link_user_mailer_test = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.mailer.icons.icon_user_mailer_test',
