...
from appsaabaza.apps.document_states.permissions import permission_workflow_edit
from appsaabaza.apps.document_states.tests.base import ActionTestCase
from appsaabaza.apps.document_states.tests.mixins import (
    WorkflowStateActionViewTestMixin, WorkflowTestMixin
)
from appsaabaza.apps.metadata.tests.mixins import MetadataTypeTestMixin
...
class EmailActionTestCase(MailerTestMixin, WorkflowTestMixin, ActionTestCase):
    ...
    def test_email_action_workflow_execute(self):
        ...
        self.test_workflow_state.actions.create(
            ...
            action_path='appsaabaza.apps.mailer.workflow_actions.EmailAction',
...
class EmailActionViewTestCase(
    ...
    def test_email_action_create_get_view(self):
        ...
        response = self._request_test_workflow_template_state_action_create_get_view(
            class_path='appsaabaza.apps.mailer.workflow_actions.EmailAction'
        )
