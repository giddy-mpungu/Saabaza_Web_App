...
link_document_type_web_links = Link(
    ...
    icon_class_path='appsaabaza.apps.web_links.icons.icon_document_type_web_links',
...
link_web_link_create = Link(
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_create',
    permissions=(permission_web_link_create,),
    text=_('Create new web link'), view='web_links:web_link_create'
)
link_web_link_delete = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_delete',
...
link_web_link_document_types = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_document_types',
    permissions=(permission_web_link_edit,),
    text=_('Document types'), view='web_links:web_link_document_types',
)
link_web_link_edit = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_edit',
    permissions=(permission_web_link_edit,),
    text=_('Edit'), view='web_links:web_link_edit',
)
link_web_link_instance_view = Link(
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_instance_view',
...
link_document_web_link_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.web_links.icons.icon_document_web_link_list',
...
link_web_link_list = Link(
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_list',
    text=_('Web links'), view='web_links:web_link_list'
)
link_web_link_setup = Link(
    icon_class_path='appsaabaza.apps.web_links.icons.icon_web_link_setup',
