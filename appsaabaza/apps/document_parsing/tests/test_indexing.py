from appsaabaza.apps.common.tests.base import BaseTransactionTestCase
from appsaabaza.apps.documents.tests.literals import TEST_HYBRID_DOCUMENT
from appsaabaza.apps.documents.tests.mixins import DocumentTestMixin
from appsaabaza.apps.document_indexing.models import Index, IndexInstanceNode
from appsaabaza.apps.document_indexing.tests.literals import TEST_INDEX_LABEL
