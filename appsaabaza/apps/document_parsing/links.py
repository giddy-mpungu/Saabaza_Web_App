...
link_document_content = Link(
    ...
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_content',
...
link_document_content_delete = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_content_delete',
...
link_document_parsing_errors_list = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_parsing_errors_list',
...
link_document_content_download = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_content_download',
...
link_document_submit_multiple = Link(
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_submit',
...
link_document_type_parsing_settings = Link(
    args='resolved_object.id',
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_type_parsing_settings',
...
link_document_type_submit = Link(
    ...
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_document_type_submit',
    text=_('Parse documents per type'),
    view='document_parsing:document_type_submit'
)
link_error_list = Link(
    icon_class_path='appsaabaza.apps.document_parsing.icons.icon_link_error_list',
