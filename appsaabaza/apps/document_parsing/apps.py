...
from appsaabaza.apps.common.classes import ModelFieldRelated, ModelProperty
from appsaabaza.apps.common.menus import (
    menu_facet, menu_list_facet, menu_multi_item, menu_secondary, menu_tools
)
from appsaabaza.apps.documents.search import document_search, document_page_search
from appsaabaza.apps.documents.signals import post_version_upload
from appsaabaza.apps.events.classes import ModelEventType
...
class DocumentParsingApp(AppsaabazaAppConfig):
    app_namespace = 'document_parsing'
    app_url = 'parsing'
    has_rest_api = True
    has_tests = True
    name = 'appsaabaza.apps.document_parsing'
