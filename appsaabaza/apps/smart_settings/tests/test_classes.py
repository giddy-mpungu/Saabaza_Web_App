...
from appsaabaza.apps.common.settings import setting_paginate_by
from appsaabaza.apps.common.tests.base import BaseTestCase
from appsaabaza.apps.storage.utils import fs_cleanup
...
class ClassesTestCase(SmartSettingTestMixin, BaseTestCase):
    def test_environment_override(self):
        ...
        self._set_environment_variable(
            name='APPSAABAZA_{}'.format(self.test_setting.global_name),
    ...
    def test_environment_variable(self):
        self._set_environment_variable(
            name='APPSAABAZA_{}'.format(ENVIRONMENT_TEST_NAME),
...
class NamespaceMigrationTestCase(SmartSettingTestMixin, BaseTestCase):
    def test_environment_migration(self):
        self._set_environment_variable(
            name='APPSAABAZA_{}'.format(TEST_SETTING_GLOBAL_NAME),
