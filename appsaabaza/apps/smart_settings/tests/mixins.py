...
from appsaabaza.apps.common.tests.mixins import EnvironmentTestCaseMixin
from appsaabaza.apps.storage.utils import fs_cleanup, NamedTemporaryFile
...
class SmartSettingsTestCaseMixin(object):
    def setUp(self):
        ...
        with NamedTemporaryFile(delete=False) as self.test_setting_config_file_object:
            ...
            os.environ['APPSAABAZA_CONFIGURATION_FILEPATH'] = self.test_setting_config_file_object.name
...
class SmartSettingTestMixin(EnvironmentTestCaseMixin):
    ...
    def _create_test_config_file(self, callback=None):
        ...
        with NamedTemporaryFile(delete=False) as test_config_file_object:
            ...
            # Needed to update the globals before Appsaabaza has loaded.
            self._set_environment_variable(
                name='APPSAABAZA_CONFIGURATION_FILEPATH',
