...
class Statistic(object):
    ...
    def purge_schedules():
        ...
        StatisticResult = apps.get_model(
            app_label='appsaabaza_statistics', model_name='StatisticResult'
        )

        queryset = PeriodicTask.objects.filter(
            name__startswith='appsaabaza_statistics.'
    ...
    def get_task_name(self):
        return 'appsaabaza_statistics.task_execute_statistic_{}'.format(self.slug)
