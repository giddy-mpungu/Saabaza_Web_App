...
link_execute = Link(
    icon_class_path='appsaabaza.apps.appsaabaza_statistics.icons.icon_execute',
    permissions=(permission_statistics_view,), text=_('Queue'),
    view='statistics:statistic_queue', args='resolved_object.slug'
)
link_view = Link(
    icon_class_path='appsaabaza.apps.appsaabaza_statistics.icons.icon_view',
...
link_namespace_details = Link(
    icon_class_path='appsaabaza.apps.appsaabaza_statistics.icons.icon_namespace_details',
...
link_namespace_list = Link(
    icon_class_path='appsaabaza.apps.appsaabaza_statistics.icons.icon_namespace_list',
    permissions=(permission_statistics_view,), text=_('Namespace list'),
    view='statistics:namespace_list'
)
link_statistics = Link(
    icon_class_path='appsaabaza.apps.appsaabaza_statistics.icons.icon_statistics',
