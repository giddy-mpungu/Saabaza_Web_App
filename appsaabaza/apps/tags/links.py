...
link_document_multiple_tag_multiple_remove = Link(
    icon_class_path='appsaabaza.apps.tags.icons.icon_document_tag_multiple_remove',
    text=_('Remove tag'), view='tags:multiple_documents_selection_tag_remove'
)
link_document_multiple_attach_multiple_tag = Link(
    icon_class_path='appsaabaza.apps.tags.icons.icon_document_tag_multiple_attach',
    text=_('Attach tags'), view='tags:multiple_documents_tag_attach'
)
link_document_tag_list = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.tags.icons.icon_document_tag_list',
...
link_tag_list = Link(
    ...
    ), icon_class_path='appsaabaza.apps.tags.icons.icon_tag_list',
...
link_tag_document_list = Link(
    args='object.id',
    icon_class_path='appsaabaza.apps.tags.icons.icon_tag_document_list',
