...
link_logout = Link(
    ...
    icon_class_path='appsaabaza.apps.authentication.icons.icon_logout',
...
link_password_change = Link(
    ...
    icon_class_path='appsaabaza.apps.authentication.icons.icon_password_change',
    text=_('Change password'),
    view='authentication:password_change_view'
)
link_user_impersonate_start = Link(
    icon_class_path='appsaabaza.apps.authentication.icons.icon_impersonate_start',
