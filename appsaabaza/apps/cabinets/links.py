...
link_document_cabinet_list = Link(
    ...
    icon_class_path='appsaabaza.apps.cabinets.icons.icon_cabinet_list',
    permissions=(permission_document_view,),
    text=_('Cabinets'), view='cabinets:document_cabinet_list',
)
link_document_cabinet_remove = Link(
    args='resolved_object.pk',
    icon_class_path='appsaabaza.apps.cabinets.icons.icon_document_cabinet_remove',
...
link_document_cabinet_add = Link(
    args='object.pk',
    icon_class_path='appsaabaza.apps.cabinets.icons.icon_document_cabinet_add',
...
link_document_multiple_cabinet_add = Link(
    icon_class_path='appsaabaza.apps.cabinets.icons.icon_document_multiple_cabinet_add',
...
link_cabinet_view = Link(
    args='object.pk', icon_class_path='appsaabaza.apps.cabinets.icons.icon_cabinet_view',
